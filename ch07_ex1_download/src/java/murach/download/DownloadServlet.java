...
public class DownloadServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        if (action == null) {
            action = "home";   // thay vì viewAlbums
        }

// perform action and set URL to appropriate page
        String url = "/index.jsp";
        if (action.equals("home")) {
            url = "/index.jsp";   // index.jsp là trang chủ
        } else if (action.equals("viewAlbums")) {
            url = "/index.jsp";   // hoặc bạn để chung vào index.jsp luôn
    ...
    private String registerUser(HttpServletRequest request,
        ...
        Cookie c = new Cookie("userEmail", user.getEmail());
        c.setMaxAge(60 * 60 * 24 * 365 * 3); // 3 năm
        c.setPath("/"); // cho cookie có hiệu lực toàn site
